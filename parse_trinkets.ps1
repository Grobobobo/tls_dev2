[xml]$xmlContent = Get-Content "c:\Users\Marcin\Desktop\tls_dev\base_files\ItemDefinitions_Trinkets"
...
# Export to CSV
$csvData | Export-Csv -Path "c:\Users\Marcin\Desktop\tls_dev\ItemDefinitions_Trinkets.csv" -NoTypeInformation

Write-Host "CSV file created successfully at c:\Users\Marcin\Desktop\tls_dev\ItemDefinitions_Trinkets.csv"
