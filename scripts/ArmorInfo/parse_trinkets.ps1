[xml]$xmlContent = Get-Content "./base_files/ItemDefinitions_Trinkets"
...
# Export to CSV
$csvData | Export-Csv -Path "./ItemDefinitions_Trinkets.csv" -NoTypeInformation

Write-Host "CSV file created successfully at ./ItemDefinitions_Trinkets.csv"
