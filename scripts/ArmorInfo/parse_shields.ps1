[xml]$xmlContent = Get-Content "./base_files/ItemDefinitions_Shields"
...
# Export to CSV
$csvData | Export-Csv -Path "./ItemDefinitions_Shields.csv" -NoTypeInformation

Write-Host "CSV file created successfully at ./ItemDefinitions_Shields.csv"
